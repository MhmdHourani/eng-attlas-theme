    ...
    <main class="main" role="main">
        ...
        <section id="about" class="section services section-padding section--dark-bg" style="background: url(<?= get_template_directory_uri() ?>/assets/images/contact/pattern.png) repeat center #222222;">
            <div class="container" style="padding-inline: 30px;text-align: justify;">
                <div class="section__number wow animate__animated animate__fadeInDown light" id="vision">
                    <h2>About Alattas</h2>
                </div>
                ...
                <div class="section__image" style="background-image: url(<?= get_template_directory_uri() ?>/assets/images/services/services__image-1.jpg);"></div>
            </div>
        </section>
        <!-- strategy -->
