        ...
        <div class="container">
            <div class="footer__inner">
                ...
                <ul class="footer-nav footer-nav--social list">
                    ...
                    <li>
                        <a title="follow sumou via twitter" href="<?= get_theme_mod('tw_social_media'); ?>" target="_blank">
                    ...
                    <li>
                        <a title="follow sumou via instagram" href="<?= get_theme_mod('instg_social_media'); ?>" target="_blank">
                    ...
                    <li>
                        <a title="follow sumou on youtube" href="<?= get_theme_mod('youtube_social_media'); ?>" target="_blank">
                    ...
                    <li>
                        <a title="follow sumou on facebook" href="<?= get_theme_mod('fb_social_media'); ?>" target="_blank">
